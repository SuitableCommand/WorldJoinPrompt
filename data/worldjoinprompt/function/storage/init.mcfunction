execute unless data storage minecraft:worldjoin_prompt prompt.display run function worldjoinprompt:enable
...
execute unless data storage minecraft:worldjoin_prompt prompt.tips[0] run data modify storage minecraft:worldjoin_prompt prompt.tips set value ["Disable with /function worldjoinprompt:disable"]
